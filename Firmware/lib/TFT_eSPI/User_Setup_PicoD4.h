...
#define TOUCH_CS 04     // Chip select pin (T_CS) of touch screen
...
//This is the maximum for the normal Pi Displays
   #define SPI_FREQUENCY  26000000

//This is the max we can use for the wavsahre 3.5" ( C ) 
